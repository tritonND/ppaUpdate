...
if (isset($_POST['id']) && !empty($_POST['id'])) {
    ...
    $query2 = "SELECT projectdetails.PROJECTID,  projectdetails.TITLE , projectdetails.LGA, projectdetails.CONTRACTSUM, certificates.AMOUNT AS cAmount, variations.AMOUNT AS vAmount
FROM projectdetails
