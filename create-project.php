...
if(isset($_SESSION['privileges']))
{
    ...
    if((strpos($priv,"createproject")!==FALSE)||(strpos($priv,"sysadmin")!==FALSE))//check if he has createproject privilege
    {
...
$result1=mysqli_query($con, "select COMPANYNAME from supervisors where TYPE='contractor' and ACTIVE=1 ");
...
$result3=mysqli_query($con, "select * from sectors where CODE='$usertype' ");   
...
<head>
    ...
    <title>EDPMS | EDPMS Create Project</title>
...
<?php } else{ ?>
                            <div class="form-group">
                                 <select id="sector" name="sector" class="form-control"
                                         data-required-error="Sector is required" disabled>
                                ...
                                <div class="form-group">
                                    <select id="subsector" class="form-control datalist" name="subsector" required
                                            data-required-error="project sub-sector is required" disabled>
                                        <option value="<?php echo $mda; ?>"><?php echo $mda;?></option>
...
<?php } else{ ?>
                                                      <div class="form-group">
                                                        <select id="mda" class="form-control datalist" name="mda" required
                                                                data-required-error="MDA is required">
                                                            <option value="">Select MDA</option>
                                                            <option value="<?php echo $usertype; ?>"><?php echo $mda;?></option>
...
<?php } ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="projecttitle">Requisition ID:</label>
                                                        <input type="text" class="form-control" id="reqid" name="reqid"
                                                               data-required-error="Oracle requisition number is required">
                                                        <div class="help-block with-errors"></div>
                                                    </div>
...
<textarea id="projectdescription" name="projectdescription" style="width:100%;" required
          data-required-error="project description is required"></textarea>
                                                        <div class="help-block with-errors"></div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="dateofaward">Date of Award:</label>
                                                        <input type="text" class="form-control mydatepicker" id="dateofaward" name="dateofaward" required
...
<textarea id="projectlocation" name="projectlocation" style="width:100%;" required
          data-required-error="project location is required"></textarea>
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control mydatepicker" id="expecteddateofcompletion" name="expecteddateofcompletion" required
                                        ...
                                        <div id="step-4">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-7 col-xs-offset-2 ">
                                                    <div class="form-group">
                     <select id="consultant" name="consultant" class="form-control" data-required-error="Consultant is required">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 col-xs-offset-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="contractsum" name="contractsum" required
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="mobilisationpaid" name="mobilisationpaid" required
                                                               onblur="formatCurrency(this)"
...
<script src="myjs/createproject.js"></script>
<script>
