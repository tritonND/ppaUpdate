...
<head>
    ...
    <script src="js/myajaxcode.js"></script>
    <style>
...
<body style="font-family: 'Segoe UI'; margin-bottom: 6px">
...
<br> <br>
<div>
<img src="img/icon.png"  width="185" height="auto" style=" display: block; margin-left: auto; margin-right: auto; ">
<h2 align="center" style="color: #405a88">Welcome to EDO ICTA Reports Portal</h2>

</div>

<div class="container">
    <span id="loginresponse" style="margin-left:40%;color: red;font-size: 1.2em;"></span>
    <!--
    ...
    <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
        ...
        <div class="panel panel-default" >
            ...
            <div class="panel-heading">
                <div id="formTitle" class="panel-title text-center">Enter Login Credentials</div>
            </div>

            

            <div class="panel-body" >
                <form class="form-horizontal"  method="post" name="login-form" id="login-form" autocomplete="off">

                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        <input id="username" type="text" class="form-control" name="user_email" value="" placeholder="Username">
                    </div>
                    ...
                    <div class="form-group" style="padding-top: 1%">
                        <div class="col-sm-12 controls" align="center">
                            <button type="button" onclick="login();" name="btn-login" id="btn-login" class="btn btn-primary"><i class="glyphicon glyphicon-log-in"></i> Log in</button>
                        </div>
                    </div>
