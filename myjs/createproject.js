...
//var target = document.getElementById('spinnerdiv');
            ...
            var subsector=$('#subsector :selected').text();
            ...
            var x = $.ajax(
                {
                    ...
                    data: "sector="+encodeURIComponent(sector)+"&subsector="+encodeURIComponent(subsector)+"&projectid="+encodeURIComponent(projectid)
                    +"&mda="+encodeURIComponent(mda)+"&reqid="+encodeURIComponent(reqid)+"&projecttitle="+encodeURIComponent(projecttitle)+"&projectdescription="+encodeURIComponent(projectdescription)+"&dateofaward="+encodeURIComponent(dateofaward)
                    ...
                    +"&mobilisationpaid="+encodeURIComponent(mobilisationpaid)
