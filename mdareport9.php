                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="header">
                                    ...
                                    <p class="category">All MDAs Projects categorized by Contractors Handling it</p>
                                </div>
                                <div class="content table-responsive">
                                    <div id="chartActivity" class="ct-chart">
                                        ...
                                        <table id="myTable" class="table table-condensed table-striped table-bordered table-hover">
                                            ...
                                            $query = "SELECT CONTRACTOR, count(*) FROM projectdetails projectdetails GROUP BY CONTRACTOR ";
