...
<?php include './sidemenu.php'; ?>
  ...
  <!-- card 2 -->
    ...
    <?php
    //  $conn = mysqli_connect('localhost', 'user', 'password', 'db', 'port');
       $query1 = "SELECT title, lga, dateofaward FROM projectdetails ORDER BY RAND() DESC LIMIT 5";
  ...
  <!-- card 2 -->
    ...
    <?php
    //  $conn = mysqli_connect('localhost', 'user', 'password', 'db', 'port');
       $query1 = "SELECT title, procuringentity, contractsum FROM projectdetails ORDER BY RAND() DESC LIMIT 5";
