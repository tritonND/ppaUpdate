...
if((strpos($priv,"updateproject")!==FALSE)||(strpos($priv,"sysadmin")!==FALSE))//check if he has dashboard privilege
{
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <h4 id="oraclenumber" class="certphotosection" style="font-weight:bold;color:green;display:none;"></h4>
