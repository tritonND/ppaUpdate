        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="col-sm-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Projects By Contractors</h4>
                                <p class="category">All Contractors Projects Contract Sum categorized by LGA</p>
                            </div>
                            <div class="content">
                                <div id="chartActivity" class="ct-chart">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-md-5 col-md-offset-5">
                                            <a href="mdareport99.php" type="button" class="btn  btn-primary">View Contractors Financials</a>
