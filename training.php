          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3> Training, Exams and Customer Service <small> Training Department</small> </h3>
              </div>
...
$result = mysqli_query($con,"SELECT * FROM alltab WHERE designation LIKE 'Training%'");
?>
...
<!--            opendata plans-->
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> Plans Report <small></small></h2>
